...
class BalanceFragment : Fragment() {
    ...
    private fun setIconClickListeners() {
        binding.btnConnectWithBankAccount.setOnClickListener { activity?.showToast(getString(R.string.equisite_pigeons_are_working)) }
        binding.btnScan.setOnClickListener { activity?.showToast(getString(R.string.equisite_pigeons_are_working)) }
        binding.btnUpload.setOnClickListener { activity?.showToast(getString(R.string.equisite_pigeons_are_working)) }
        binding.btnManual.setOnClickListener { activity?.replaceFragment(R.id.balanceFragmentContainer, ManualFragment(), false) }
    }
